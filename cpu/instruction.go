...
const (
	...
	OpcodeLDReg uint16 = 0x0000
	OpcodeOR    uint16 = 0x0001
	OpcodeAND   uint16 = 0x0002
	OpcodeXOR   uint16 = 0x0003
	OpcodeADD   uint16 = 0x0004
	OpcodeSUB   uint16 = 0x0005
	OpcodeSHR   uint16 = 0x0006
	OpcodeSUBN  uint16 = 0x0007
	OpcodeSHL   uint16 = 0x000E
